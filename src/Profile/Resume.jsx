            ...
            <div className="profile">
                ...
                <div className="info">
                    ...
                    <ul className="contact-info">
                        <li>
                            Email:<a href="mailto:niharikajivijay@gmail.com"> niharikajivijay@gmail.com</a>
                        </li>
                        <li>
                            Website: <a href="https://www.linkedin.com/feed/">Linkedin/niharika-vijayvargiya</a>
                        </li>
                    </ul>
                </div>
            </div>
